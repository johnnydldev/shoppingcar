...
Vue.component('contacts-component', require('./components/contacts/ContactsComponent.vue').default);
Vue.component('contacts-card-component', require('./components/contacts/ContactsCardComponent.vue').default);
